 ...
 * NOTE!
 *
 * This version of html2canvas contains a patch to resolve an IE11 issue with fonts.
 * If upgrading to a newer version of the library ensure that either the IE11 font
 * issue has been fixed upstream, or that the patch gets re-applied.  Failure to do
 * so will cause custom fonts not to render in IE11.
 * https://github.com/niklasvh/html2canvas/issues/1458
 */

/**
 * NOTE
 *
 * This version of html2canvas contains a patch to fix the issue with multiple
 * shadows being unnecessarily rendered in the generated screenshot.
 * If upgrading to a newer version of the library, ensure that either this issue
 * has been fixed upstream, or that the patch gets re-applied. Failure to do so
 * will cause undesired outcomes related to multiple unnecessary shadows being
 * generated in the screenshot.
 * See: NXTGNCFG-3077, NXTGNCFG-3530, NXTGNCFG-3985
 *
 * Refer:
 * Pull-request: https://github.com/niklasvh/html2canvas/pull/1653/files
 * Issue: https://github.com/niklasvh/html2canvas/issues/1638
 * */
...
hero("html2canvas", function () {
                    ...
                    var CanvasRenderer = function () {
                        ...
                        _createClass(CanvasRenderer, [{
                            ...
                            value: function renderTextNode(textBounds, color, font, textDecoration, textShadows) {
                                ...
                                this.ctx.font = [font.fontStyle, font.fontVariant, font.fontWeight, font.fontSize, font.fontFamily.indexOf(',') > -1 ? font.fontFamily : '\'"'.indexOf(font.fontFamily.charAt(0)) > -1 ? font.fontFamily.replace(/['"]/g, '') : JSON.stringify(font.fontFamily)].join(' ');
    ...
    /***/
                (function (module, exports, __webpack_require__) {
                    ...
                    var parseCSSFloat = exports.parseCSSFloat = function parseCSSFloat(f) {
                        switch (f) {
                            case 'left':
                                return FLOAT.LEFT;
                            case 'right':
